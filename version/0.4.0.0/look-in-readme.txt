look-in 0.4.0.0 Miranda IM plugin
...
new line. The enclosing of the tags is unlimited.

New line tag

<tmplBr>

When template is parsed, programm cut all new line symbols (0D 0A).
To insert in result the new line characters, you should use this new
line tag.
